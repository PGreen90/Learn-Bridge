...
const ALL_ENGINE_RULES: string[] = [
  ...
  'Gambling 3NT', 'Gambling: 4♣ pass eller rätta', 'Gambling: 5♣ pass eller rätta', 'Gambling: 4M till spel', 'Gambling: rättelse', 'inkliv över Gambling 3NT', '4NT kvantitativ', '5-korts högfärg', '6NT till spel', 'Bergen game try',
  ...
  'fullföljd transfer', 'färgbud', 'fritt bud', 'gap-hand 1NT', 'hopp i egen färg (inbjudan)',
  ...
  'oklart', 'ovanlig 2NT', 'pass', 'resonemang', 'preferens (GF)', 'preferens', 'rebid: 2NT (18–19)',
  'rebid: 2NT (22–24)', 'rebid: 3NT (25–27)', 'rebid: 4NT (28–30)', 'rebid: 3NT (GF)', 'rebid: 3NT',

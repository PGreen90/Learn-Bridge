...
const FORCING_BY_RULE: Record<string, Forcing> = {
  ...
  // Michaels-fortsättningen, ostörd (bridgebum + ägarbesked 2026-09-22, §7.2)
  'advance Michaels: cue (utgångsintresse)': 'krav-1-rond',
  'advance Michaels: spärrhöjning': 'ej-krav',
  'advance Michaels: 3NT': 'avslut',
  'advance Michaels: egen färg': 'ej-krav',
  'advance Michaels: utgång': 'avslut',
  'Michaels: passar avslutet': 'avslut',
  'Michaels: inbjudan': 'inbjudan',
  'Michaels: utgång': 'avslut',
  'Michaels: svag efter cue': 'ej-krav',
  'Michaels: stark efter cue': 'utgangskrav',
  'Michaels: accepterar inbjudan': 'avslut',
  'Michaels: avböjer inbjudan': 'avslut',
  'Michaels: utgång efter cue': 'avslut',
  'Michaels: stannar efter cue': 'avslut',
  // Ovanlig 2NT-fortsättningen, ostörd (ägarbeslut 2026-09-21/22, §7.2)
  'advance ovanlig 2NT: cue (utgångsintresse)': 'krav-1-rond',
  'advance ovanlig 2NT: spärrhöjning': 'ej-krav',
  'advance ovanlig 2NT: 3NT': 'avslut',
  'advance ovanlig 2NT: egen färg': 'ej-krav',
  'advance ovanlig 2NT: utgång': 'avslut',
  'efter ovanlig 2NT: passar avslutet': 'avslut',
  'efter ovanlig 2NT: inbjudan': 'inbjudan',
  'efter ovanlig 2NT: utgång': 'avslut',
  'efter ovanlig 2NT: svag efter cue': 'ej-krav',
  'efter ovanlig 2NT: stark efter cue': 'utgangskrav',
  'efter ovanlig 2NT: accepterar inbjudan': 'avslut',
  ...
  'återbud i konkurrens: 5-4 utan stopp': 'krav-1-rond',
  ...
  'fritt bud: rebjuder egen 6+ (konkurrens)': 'ej-krav',
  'fritt bud: 3NT med stopp': 'avslut',
  'fritt bud: 2NT med stopp': 'inbjudan',

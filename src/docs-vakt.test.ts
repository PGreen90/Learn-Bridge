...
const GENERERADE = new Set(['manifest.json', 'latest.json', 'speldiagnos-latest.json', 'tredjehand-latest.json', 'auktionsdump.json', 'auktionsdump-baslinje.json'])
...
const MEDVETET_EJ_INKOPPLAD: Record<string, string> = {
  ...
  'resonemang.ts': 'Resonemangslagret steg 1 (docs/sunt-fornuft-plan.md) — körs bara av resonemang.probe.test.ts tills steg 3 kopplar in det vid bordet.',
}

...
|---|---|---|
| **budsystem.md** (230 kB) | ðŸ“˜ | du ska Ã¤ndra eller slÃ¥ upp en **budregel**. Systemboken i paragrafform. **Appens Budsystem-sida renderar den hÃ¤r filen live fÃ¶r Ã¤garen** â€” varje regelÃ¤ndring MÃ…STE skrivas in hÃ¤r. Â§9 = Ã¤ndringslogg (visas inte pÃ¥ sidan). |

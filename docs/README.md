...
| **imp-tavling-plan.md** | 🟢 | **Dagens IMP (ägarbeslut 2026-09-26, NU — PLANERAD, inget byggt):** en andra daglig tävling med tolv nya givar räknade i IMP (tabellen, cross-IMP, summan, −3 IMP provisoriskt), de fyra greppen (`form`-kolumnen, frönyckeln, formen som parameter, aggregatet generaliserat), kartan över allt som rörs, etapp 0–5 med grindar och deploy-sekvensen 0013 → deploy → 0014. Öppna den FÖRST vid allt IMP-arbete. |

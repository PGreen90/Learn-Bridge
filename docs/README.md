...
| Fil | 🟢/📘/📦 | Öppna den när … |
|---|---|---|
| **budsystem.md** (364 kB) | 📘 | du ska ändra eller slå upp en **budregel**. Systemboken i paragrafform. **Appens Budsystem-sida renderar den här filen live för ägaren** — varje regeländring MÅSTE skrivas in här. §9 = ändringslogg (visas inte på sidan). |
...
| **ovanlig-2nt-plan.md** | 🟢 | **Ovanlig 2NT — fortsättningen (BYGGD 2026-09-21; strukturen i budsystem §7.2):** förarbetet + vad motorn gör i dag (provat), bridgebums struktur, frågorna till ägaren, var det byggs (kartan från Michaels-bygget) och lärdomarna från Michaels-dagen. **Läs den först i nästa session.** |

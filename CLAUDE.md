...
ägarbeslut tagna 2026-09-05; beslut 1 LIVE (`3491ece`), 3 LIVE (`1a6adf0`), 7 LIVE (`820ab71`), 14 LIVE (`4be2ba3`), 2 LIVE (`f7d5c72`), 13 BYGGT 2026-09-07 (väntar PCD).**
...
**Nästa gång börjar vi med:** beslut 4 (rena steg i splinterreläet efter
1♠–3♥–3♠: kort ♣→3NT, ♦→4♣, ♥→4♦), test-drivet (facit FÖRE fix, systembok §,
regel i nya lagret), ett beslut per commit i byggordningen (§5b sist: 1 ✔ → 3 ✔
→ 7 ✔ → 14 ✔ → 2 ✔ → 13 ✔ → 4 → 5 → 9 → 6 → 11 → 12 → 16) → PCD per grönt steg,

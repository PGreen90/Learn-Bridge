...
("Påbyggnad — tävlingens livskvalitet"). **Läge: etapp A + B + C + E + D1 + D2 KLARA** (2026-09-13; 🚪 ägarsteg: kör
migration `0012` i Supabase, sedan `workflow_dispatch` på tavling-granskning);
nästa = D3 (historiksidan + medaljtabellen).
